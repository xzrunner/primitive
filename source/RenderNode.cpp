...
void RenderNode::AddLine(const sm::vec2& p0, const sm::vec2& p1, uint32_t col, float size)
{
...
void RenderNode::AddRect(const sm::vec2& p0, const sm::vec2& p1, uint32_t col, uint32_t rounding, float size)
{
	if ((col & COL32_A_MASK) == 0) {
		return;
	}
...
void RenderNode::AddRectFilled(const sm::vec2& p0, const sm::vec2& p1, uint32_t col, uint32_t rounding)
{
	if ((col & COL32_A_MASK) == 0) {
		return;
	}
...
void RenderNode::AddPolyline(const sm::vec2* points, size_t count, uint32_t col, float size)
{
	if ((col & COL32_A_MASK) == 0) {
		return;
	}
...
void RenderNode::AddPolygon(const sm::vec2* points, size_t count, uint32_t col, float size)
{
	if ((col & COL32_A_MASK) == 0) {
		return;
	}
...
void RenderNode::AddPolygonFilled(const sm::vec2* points, size_t count, uint32_t col)
{
	if ((col & COL32_A_MASK) == 0) {
		return;
	}
...
void RenderNode::Stroke(const sm::vec2* points, size_t ori_count, uint32_t col, bool closed, float size)
{
...
void RenderNode::Fill(const sm::vec2* points, size_t count, uint32_t col)
{
...
void RenderNode::Stroke(const Path& path, uint32_t col, float size)
{
...
void RenderNode::Fill(const Path& path, uint32_t col)
{
	for (auto& path : path.GetPrevPaths()) {
...
//////////////////////////////////////////////////////////////////////////
// struct RenderNode::Buffer
//////////////////////////////////////////////////////////////////////////

void RenderNode::Buffer::Reserve(size_t idx_count, size_t vtx_count)
{
